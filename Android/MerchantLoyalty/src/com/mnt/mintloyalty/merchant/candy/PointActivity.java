...
public class PointActivity extends Activity{
	...
	String mobile,merchantProgId,programId;
	SharedPreferences preferences;
	private ProgressBar progressBar;
	TextView amountView,pointsView;
	Button goBtn;
	EditText setAmountEdt;
	Typeface font;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.logout).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				LoginActivity.handleLogout(PointActivity.this);
	...
	public class CandyAdapter extends ArrayAdapter<Point>
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			try{
				...
				String imageUrl=domainObj.candyiconUrl+getItem(position).pointURL;
		...
		alert.setPositiveButton("Stamp", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				if(value.length()>1){
					...
					Toast.makeText(PointActivity.this,"Invalid Code",Toast.LENGTH_SHORT).show();
				}
			}
		});
	...
	public void onBackPressed() {
		Intent intent = new Intent();
		intent.setClass(PointActivity.this,ProgramsActivity.class);
		intent.putExtra("Mobile",mobile);
		startActivity(intent);
		finish(); 
	} 
