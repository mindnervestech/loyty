...
public class NearDetailActivity extends MenuActivity{
	...
	private class GetCategoryTask extends AsyncTask<Void, Void, Void>
	 {
		...
		protected void onPostExecute(Void result)
		{
				...
				MerchantAdapter adapter=new MerchantAdapter(NearDetailActivity.this,R.id.name,candiesData);			
	...
	public class MerchantAdapter extends ArrayAdapter<Candy>
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			try{
				...
				String imageUrl =Domain.imageUrl+getItem(position).imageUrl;
	  ...
	  public void onBackPressed() {
			 Intent i = new Intent();
		     i.setClass(NearDetailActivity.this,NearMintActivity.class);
	         startActivity(i);
	         finish();
		}
